...
After the data are modified to impute missing values, the resultant mean & median analysis reflects <b>`r nrow(mean.of.imputed.total.steps.by.date)`</b> observations. //RICK ADD HISTOGRAM!!!
